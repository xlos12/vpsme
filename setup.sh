...
echo -e "$green.........................................................."$NC
echo -e "$Lyellow                  Autoscript By xlos12"$NC
echo -e "$Lyellow                    CONTACT TELEGRAM"$NC
echo -e "$Lyellow                       @xlos12"$NC
echo -e "$green.........................................................."$NC
echo ''
...
VALIDITY() {
    ...
    if [[ $today < $Exp1 ]]; then
        echo -e "\e[32mCongratulations! You are Allowed to use AUTOSCRIPT xlos12..\e[0m"
        sleep 5
    else
...
wget https://raw.githubusercontent.com/xlos12/vpsme/main/install/ins-xray.sh && chmod +x ins-xray.sh && screen -S ins-xray ./ins-xray.sh
...
echo -e "\e[1;32m══════════════════ Autoscript By xlos12 ══════════════════\e[0m" | tee -a log-install.txt
sleep 7
clear
echo ""
echo -e "    \e[1;32m.------------------------------------------.\e[0m"
echo -e "    \e[1;32m|     SUCCESFULLY INSTALLED THE SCRIPT     |\e[0m"
echo -e "    \e[1;32m|        PREMIUM BY xlos12      |\e[0m"
echo -e "    \e[1;32m'------------------------------------------'\e[0m"
echo ""
