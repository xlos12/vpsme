...
VALIDITY () {
    ...
    Exp1=$(curl -sS https://raw.githubusercontent.com/xlos12/allow/main/ipvps.conf | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl -sS https://raw.githubusercontent.com/xlos12/allow/main/ipvps.conf | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
mkdir /root/.acme.sh
curl https://raw.githubusercontent.com/xlos12/vpsme/main/acme.sh -o /root/.acme.sh/acme.sh
...
# download script
cd /usr/bin
#wget -O port-xray "https://raw.githubusercontent.com/xlos12/sapphire/main/change-port/port-xray.sh"
#wget -O certv2ray "https://raw.githubusercontent.com/xlos12/sapphire/main/cert.sh"
#wget -O trojaan "https://raw.githubusercontent.com/xlos12/sapphire/main/menu/trojaan.sh"
#wget -O xraay "https://raw.githubusercontent.com/xlos12/sapphire/main/menu/xraay.sh"

wget -O port-xray "https://raw.githubusercontent.com/xlos12/vpsme/main/change-port/port-xray.sh"
wget -O certv2ray "https://raw.githubusercontent.com/xlos12/vpsme/main/cert.sh"
wget -O trojaan "https://raw.githubusercontent.com/xlos12/vpsme/main/menu/trojaan.sh"
wget -O xraay "https://raw.githubusercontent.com/xlos12/vpsme/main/menu/xraay.sh"
